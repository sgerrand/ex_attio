defmodule Attio.Comments do
  ...
  def get(%Client{} = client, comment_id) do
    Client.request(client, :get, "/v2/comments/#{comment_id}")
  end
  ...
  def update(%Client{} = client, comment_id, attrs) when is_map(attrs) do
    Client.request(client, :patch, "/v2/comments/#{comment_id}", json: %{"data" => attrs})
  end
  ...
  def delete(%Client{} = client, comment_id) do
    Client.request(client, :delete, "/v2/comments/#{comment_id}")
  end
end
