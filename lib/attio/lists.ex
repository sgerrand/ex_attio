defmodule Attio.Lists do
  ...
  def get(%Client{} = client, list_id) do
    Client.request(client, :get, "/v2/lists/#{list_id}")
  end
  ...
  def update(%Client{} = client, list_id, attrs) when is_map(attrs) do
    Client.request(client, :patch, "/v2/lists/#{list_id}", json: %{"data" => attrs})
  end
  ...
  def list_views(%Client{} = client, list_id) do
    Client.request(client, :get, "/v2/lists/#{list_id}/views")
  end
end
