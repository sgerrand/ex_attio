defmodule Attio.MeetingsTest do
  ...
  describe "list/2" do
    test "returns a page of meetings", %{client: client} do
      Req.Test.stub(__MODULE__, fn conn ->
  ...
  describe "get/2" do
    test "returns a single meeting", %{client: client} do
      Req.Test.stub(__MODULE__, fn conn ->
  ...
  describe "create/2" do
    test "creates a meeting", %{client: client} do
      Req.Test.stub(__MODULE__, fn conn ->
        Req.Test.json(conn, %{"data" => @meeting})
      end)
  ...
  describe "update/3" do
    test "updates a meeting", %{client: client} do
      Req.Test.stub(__MODULE__, fn conn ->
  ...
  describe "delete/2" do
    test "deletes a meeting", %{client: client} do
      Req.Test.stub(__MODULE__, fn conn ->
        Req.Test.json(conn, %{})
      end)
